...
- (void) selectDay:(int)day{
	...
	if(day == today){
		...
		//self.currentDay.shadowOffset = CGSizeMake(0, -1);
		// self.selectedImageView.image=[UIImage imageNamed:@"day-cell.png"];
       selectedImageView=[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Active-day-cell.png"]];
...
- (void) reactToTouch:(UITouch*)touch down:(BOOL)down{
	...
	if(portion != 1){
		...
		//self.dot.shadowOffset = CGSizeMake(0, -1);
		//self.currentDay.shadowOffset = CGSizeMake(0, -1);
         self.selectedImageView.image=[UIImage imageNamed:@"Active-day-cell.png"];
...
+(void)DragAndDrop1{
    PlannerAppAppDelegate *appdel=(PlannerAppAppDelegate *)[[UIApplication sharedApplication]delegate];
    NSLog(@"%@",appdel.set);
    [self reactToTouch:[appdel.set anyObject] down:NO];
...
- (id) init{
   // [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(DragAndDrop1) name:@"pushIt" object:nil];
